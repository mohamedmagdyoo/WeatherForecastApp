package com.example.weatherforecast.view.favoriteScreens.favoriteScreen.view
...
import com.example.weatherforecast.view.favoriteScreens.favoriteScreen.viewModel.FavoritesViewModel
import com.example.weatherforecast.view.favoriteScreens.favoriteScreen.viewModel.FavoritesViewModelFactory
...
fun FavoritesScreen(navController: NavHostController) {
    ...
    val weatherRepo = (appContext as MyApplication).appContainer.weatherRepo
    //=========================================
    val factoryForAddToFavViewModel = remember {
